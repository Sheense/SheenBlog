...
<div id="wrapper">
  ...
  <div class="con_content">
    <div class="about_box">
      ...
      <div class="lispic">
        <ul>
          <li><a href="${pageContext.request.contextPath}/show?name=ailun"><img src="images/ailun.jpg"><span>图片展示</span></a></li>
          <li><a href="${pageContext.request.contextPath}/show?name=xiamu"><img src="images/xiamu.jpg"><span>图片展示</span></a></li>
          <li><a href="${pageContext.request.contextPath}/show?name=sanli"><img src="images/sanli.jpg"><span>图片展示</span></a></li>
          <li><a href="${pageContext.request.contextPath}/show?name=yeliang"><img src="images/yeliang.jpg"><span>图片展示</span></a></li>
          <li><a href="${pageContext.request.contextPath}/show?name=yeliangnvzhu"><img src="images/yeliangnvzhu.jpg"><span>图片展示</span></a></li>
          <li><a href="${pageContext.request.contextPath}/show?name=buzhiming"><img src="images/buzhiming.jpg"><span>图片展示</span></a></li>
          <li><a href="${pageContext.request.contextPath}/show?name=bingzhang"><img src="images/bingzhang.jpg"><span>图片展示</span></a></li>
          <li><a href="${pageContext.request.contextPath}/show?name=saber"><img src="images/saber.jpg"><span>图片展示</span></a></li>
        </ul>
      </div>
