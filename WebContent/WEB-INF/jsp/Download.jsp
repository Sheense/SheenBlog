...
<title>${requestScope.downLoadCustom.title} | Sheen的个人博客</title>
...
<div id="wrapper">
   ...
   <div class="headtop"></div>
    <div class="contenttop">
      ...
      <div class="search f_r">
         <form action="${pageContext.request.contextPath}/resources/search" method="get">
  ...
  <div class="container">
    <div class="con_content">
      <div class="about_box">
        <h2 class="nh1"><span>您现在的位置是：<a href="${pageContext.request.contextPath}/" target="_blank">网站首页</a>>><a href="${pageContext.request.contextPath}/resources" target="_blank">资源共享</a></span><b>${requestScope.downLoadCustom.title}</b></h2>
        <div class="f_box">
          <p class="a_title">${requestScope.downLoadCustom.title}</p>
          <p class="p_title"></p>
            <p class="box_p"><span>发布时间：${requestScope.downLoadCustom.time_string}</span><span>浏览量：${requestScope.downLoadCustom.watchnum}</span></p>
          <!-- 可用于内容模板 -->
        </div>
        <ul class="about_content">
             ${requestScope.downLoadCustom.content}
        </ul>
...
window.document.write('<script id="changyan_mobile_js" charset="utf-8" type="text/javascript" src="https://changyan.sohu.com/upload/mobile/wap-js/changyan_mobile.js?client_id=' + appid + '&conf=' + conf + '"><\/script>'); } else { var loadJs=function(d,a){var c=document.getElementsByTagName("head")[0]||document.head||document.documentElement;var b=document.createElement("script");b.setAttribute("type","text/javascript");b.setAttribute("charset","UTF-8");b.setAttribute("src",d);if(typeof a==="function"){if(window.attachEvent){b.onreadystatechange=function(){var e=b.readyState;if(e==="loaded"||e==="complete"){b.onreadystatechange=null;a()}}}else{b.onload=a}}c.appendChild(b)};loadJs("https://changyan.sohu.com/upload/changyan.js",function(){window.changyan.api.config({appid:appid,conf:conf})}); } })(); </script>
  ...
  <footer>
    <div class="footer">
      <div class="f_l">
        <p>All Rights Reserved 版权所有：<a href="http://www.tthcclove.cn">Sheen个人博客</a> </p>
      </div>
      <div class="f_r textr">
        <p>NO GAME NO LIFE</p>
      </div>
