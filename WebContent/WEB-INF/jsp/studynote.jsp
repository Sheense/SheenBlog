...
<title>${studynoteCustom.title} | Sheen的个人博客</title>
...
<div id="wrapper">
  ...
  <div class="container">
    <div class="con_content">
      <div class="about_box">
        <h2 class="nh1"><span>您现在的位置是：<a href="${pageContext.request.contextPath}/" target="_blank">网站首页</a>>><a href="${pageContext.request.contextPath}/studynote" target="_blank">学习笔记</a></span><b>${studynoteCustom.title}</b></h2>
        <div class="f_box">
          <p class="a_title">${studynoteCustom.title}</p>
          <p class="p_title"></p>
            <p class="box_p"><span>发布时间：${studynoteCustom.time_string}</span><span>作者：${studynoteCustom.author}</span><span>类型：${studynoteCustom.type}</span><span>浏览量：${studynoteCustom.scanNum}</span></p>
          <!-- 可用于内容模板 -->
        </div>
