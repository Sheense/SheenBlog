...
<title>${requestScope.shareCustom.title} | Sheen的个人博客</title>
...
<div id="wrapper">
   ...
   <div class="headtop"></div>
    <div class="contenttop">
      ...
      <div class="search f_r">
         <form action="${pageContext.request.contextPath}/share/search" method="get">
  ...
  <div class="container">
    <div class="con_content">
      <div class="about_box">
        <h2 class="nh1"><span>您现在的位置是：<a href="${pageContext.request.contextPath}/" target="_blank">网站首页</a>>><a href="${pageContext.request.contextPath}/share" target="_blank">作品分享</a></span><b>${requestScope.shareCustom.title}</b></h2>
        <div class="f_box">
          <p class="a_title">${requestScope.shareCustom.title}</p>
          <p class="p_title"></p>
            <p class="box_p"><span>发布时间：${requestScope.shareCustom.time_string}</span><span>作者：${requestScope.shareCustom.author}</span><span>浏览量：${requestScope.shareCustom.watchnum}</span></p>
          <!-- 可用于内容模板 -->
        </div>
        <ul class="about_content">
             ${requestScope.shareCustom.content}
        </ul>
